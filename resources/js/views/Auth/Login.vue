                ...
                <div class="mt-10">
                    <form @submit.prevent="submit">
                        <div class="flex flex-col mb-6">
                            <label
                                for="email"
                                class="mb-1 text-xs sm:text-sm tracking-wide text-gray-800 font-bold"
                            >
                                E-Mail Address:
                            </label>
                            <div class="relative">
                        ...
                        <div class="flex flex-col mb-6">
                            ...
                            <div class="relative">
                                ...
                                <div
                                    class="inline-flex items-center justify-center absolute right-0 top-0 h-full w-10 text-gray-400"
                        ...
                        <div class="text-gray-700 text-sm px-4 my-4 rounded-md">
                            <RouterLink to="/client-register" class="underline"
                                >No account?</RouterLink
                            >
                        </div>
                    </form>
                </div>
