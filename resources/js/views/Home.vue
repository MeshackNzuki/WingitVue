<template>
    <section>
        <div
            className=" h-screen bg-[url('../assets/hiw.jpg')] bg-cover bg-no-repeat bg-center grid place-items-center "
        >
            <div class="max-w-screen-xl flex justify-center items-center">
                ...
                >
                    <div
                        v-if="mainStore.flights"
                        class="w-full flex justify-center md:block"
                    >
                        <Carousel
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <router-link>
                                            ...
                                            >
                                                <div
                                                    class="size-8 rounded-full ring ring-third"
                                                >
                                                    <img
                                                        :src="`https://api.wingit.co.ke/core/storage/app/public/uploads/avatars/${slotProps.data.aircraft_operator?.logo}`"
                                                        alt="User Avatar"
                                                    />
                                                </div>
                                            </div>
                                    ...
                                    <div>
                                        ...
                                        >
                                            ...
                                            <span
                                                class="font-semibold text-xs mt-4"
                                                >FLIGHT:{{
    ...
    <section class="bg-white" id="call2">
        <div class="relative flex justify-center items-center">
            <div
                class="absolute hidden w-full max-w-screen-lg bg self-center rounded-lg h-24 lg:flex justify-center"
            >
                <vue-marquee-slider
        ...
        >
            <div class="mr-auto place-sel-center lg:col-span-6">
                ...
                <div class="grid grid-flow-row auto-rows-max">
                    ...
                    <div class="bottom-0">
                        <div
                            class="collapse rounded-sm collapse-arrow collapse-white text-base bg-gold"
                        >
                            <input type="radio" name="my-accordion-2" />
                            <div class="collapse-title text-lg font-light">
                                <span
                                    class="bg-bg-500 text-base font-semibold mb-3"
                                >
                                    Book With Us Now
                                </span>
                            </div>
