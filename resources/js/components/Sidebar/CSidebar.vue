<template>
    <nav v-if="!login" ref="sidebar_id" :class="'rounded-xl fixed left-1 top-1 overflow-scroll bottom-1 dark:text-slate-300 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-lg  flex-wrap items-center justify-between z-50 py-4 w-64 px-6 transition-all ease-in-out duration-300 ' +
        (isDark
