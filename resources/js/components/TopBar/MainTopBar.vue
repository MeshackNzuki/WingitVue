<template>
    <div :class="[
        'flex flex-row justify-between items-center mb-2  md:rounded-lg p-1 md:mt-1 h-10 dark:text-slate-300 px-4',
        isDark
        ...
        <div class="hidden lg:flex">
            <span class="font-semibold uppercase text-sm" v-if="location != '404' && location != 'unauthorized'">{{
                location?.split("/")[1] }} Module</span>
            <span class="cursor-pointer font-semibold animate animate-pulse text-red-500" v-else>
                Sorry!
            </span>
        </div>
        ...
        <div class="flex justify-center items-center px-2 gap-2">
            ...
            <label class="cursor-pointer grid place-items-center">
                <input type="checkbox" value="synthwave"
                    ...
                    @click="toggleDark()" />
                <svg class="col-start-2 row-start-1 stroke-cyan-500 fill-cyan-500" xmlns="http://www.w3.org/2000/svg"
                    width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    stroke-linecap="round" stroke-linejoin="round">
                    <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path>
                </svg>
                <svg class="col-start-1 row-start-1 stroke-cyan-500 fill-cyan-500" xmlns="http://www.w3.org/2000/svg"
                    width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    stroke-linecap="round" stroke-linejoin="round">
